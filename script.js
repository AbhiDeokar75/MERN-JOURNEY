...
console.log(teams.indexOf("MI")); // returns -1
console.log(teams.indexOf("RCB")); // returns 2

// TASK -> Replace KKR with LSG

const kkrindex = teams.indexOf("KKR");
if(kkrindex != -1) {
    iplTeams[kkrindex] = "LSG";
}
console.log(teams);

//includes() function in arrays -> tells if a value is present in an array or not
...
//TASK -> Replace LSG with KKR using indexOf() and includes()

kkrindex = teams.indexOf("KKR");
if(kkrindex != -1) {
    iplTeams[kkrindex] = "LSG";
}
console.log(teams);
